...
python3 scripts/generatePatchedAppWasm.py -w /tmp/app.wat -f src/index.html -i inject/inject.wat -a inject/indexOverrides -o1 mitmoverride/app.wat.patched -o2 mitmoverride/index.html.patched && \
