...
FUNC_TYPE_T(w2c_something_t0) = "\x86\x04\x17\x5d\x74\x4c\x7f\xd1\x45\x18\xa8\x0b\x28\x4a\x22\x29\x4a\x73\xbe\xdd\xf6\x9e\x46\x5d\x81\xa4\x12\xa1\xd4\x98\x6c\x8b";

static void init_instance_import(w2c_something* instance, struct w2c_wasm0x3Ajs0x2Dstring* w2c_wasm0x3Ajs0x2Dstring_instance) {
  instance->w2c_wasm0x3Ajs0x2Dstring_instance = w2c_wasm0x3Ajs0x2Dstring_instance;
}

void wasm2c_something_instantiate(w2c_something* instance, struct w2c_wasm0x3Ajs0x2Dstring* w2c_wasm0x3Ajs0x2Dstring_instance) {
  assert(wasm_rt_is_initialized());
  init_instance_import(instance, w2c_wasm0x3Ajs0x2Dstring_instance);
}

void wasm2c_something_free(w2c_something* instance) {
}
...
wasm_rt_func_type_t wasm2c_something_get_func_type(uint32_t param_count, uint32_t result_count, ...) {
  ...
  if (param_count == 1 && result_count == 1) {
    ...
    if (true && va_arg(args, wasm_rt_type_t) == WASM_RT_EXTERNREF && va_arg(args, wasm_rt_type_t) == WASM_RT_I32) {
      va_end(args);
      return w2c_something_t0;
    }
    va_end(args);
  }
